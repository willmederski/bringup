class RepliesController < ApplicationController
  ...
  def receive
    ...
    if Pared.find_by_phone_number(@reply.from).state == 'course_num_and_phone'  || (Parent.find_by_phone_number(@reply.from).nil? && Course.find_by_id(@reply.body.to_i).present?)
      @parent=Parent.new
